...
int main()
{
	...
	const char *orden1[METHODS] =
	{
		...
		"perl gen_bateria.pl %lg %lg %lg %lg %lg 4 1 > i-4-1-%lg-%lg-%lg",
		"perl gen_bateria.pl %lg %lg %lg %lg %lg 1 2 > i-1-2-%lg-%lg-%lg",
		"perl gen_bateria.pl %lg %lg %lg %lg %lg 2 2 > i-2-2-%lg-%lg-%lg",
		"perl gen_bateria.pl %lg %lg %lg %lg %lg 3 2 > i-3-2-%lg-%lg-%lg",
		"perl gen_bateria.pl %lg %lg %lg %lg %lg 1 3 > i-1-3-%lg-%lg-%lg",
		"perl gen_bateria.pl %lg %lg %lg %lg %lg 3 3 > i-3-3-%lg-%lg-%lg",
		"perl gen_bateria.pl %lg %lg %lg %lg %lg 1 4 > i-1-4-%lg-%lg-%lg",
		"perl gen_bateria.pl %lg %lg %lg %lg %lg 3 4 > i-3-4-%lg-%lg-%lg"
	};
	const char *orden2[METHODS] =
	{
		...
		"../swocs i-4-1-%lg-%lg-%lg o-4-1-%lg-%lg-%lg "
		"f-4-1-%lg-%lg-%lg a-4-1-%lg-%lg-%lg\n",
		"../swocs i-1-2-%lg-%lg-%lg o-1-2-%lg-%lg-%lg "
		"f-1-2-%lg-%lg-%lg a-1-2-%lg-%lg-%lg\n",
		"../swocs i-2-2-%lg-%lg-%lg o-2-2-%lg-%lg-%lg "
		"f-2-2-%lg-%lg-%lg a-2-2-%lg-%lg-%lg\n",
		"../swocs i-3-2-%lg-%lg-%lg o-3-2-%lg-%lg-%lg "
		"f-3-2-%lg-%lg-%lg a-3-2-%lg-%lg-%lg\n",
		"../swocs i-1-3-%lg-%lg-%lg o-1-3-%lg-%lg-%lg "
		"f-1-3-%lg-%lg-%lg a-1-3-%lg-%lg-%lg\n",
		"../swocs i-3-3-%lg-%lg-%lg o-3-3-%lg-%lg-%lg "
		"f-3-3-%lg-%lg-%lg a-3-3-%lg-%lg-%lg\n",
		"../swocs i-1-4-%lg-%lg-%lg o-1-4-%lg-%lg-%lg "
		"f-1-4-%lg-%lg-%lg a-1-4-%lg-%lg-%lg\n",
		"../swocs i-3-4-%lg-%lg-%lg o-3-4-%lg-%lg-%lg "
		"f-3-4-%lg-%lg-%lg a-3-4-%lg-%lg-%lg\n"
	};
	const char *orden3[METHODS - 1] =
	{
		"./retraso %lg %lg %lg 1 1\n",
		"./retraso %lg %lg %lg 2 1\n",
		"./retraso %lg %lg %lg 3 1\n",
		"./retraso %lg %lg %lg 1 2\n",
		"./retraso %lg %lg %lg 2 2\n",
		"./retraso %lg %lg %lg 3 2\n",
		"./retraso %lg %lg %lg 1 3\n",
		"./retraso %lg %lg %lg 3 3\n",
		"./retraso %lg %lg %lg 1 4\n",
		"./retraso %lg %lg %lg 3 4\n"
	};
